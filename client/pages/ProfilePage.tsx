    ...
    <AnimatedPageWrapper>
      <div className="w-full min-h-screen bg-white relative max-w-sm mx-auto overflow-x-hidden">
        ...
        <div className="px-10 pb-32">
          ...
          {userData.wallet && (
            <div className="mb-8">
              <h2 className="text-lg font-normal text-black mb-4 font-[Alata]">Wallet</h2>
              <div className="flex justify-between items-center py-3 border-b border-gray-100">
                <span className="text-black font-[Alata]">Connected Wallet</span>
          ...
          {/* Statistics */}
          <div className="mb-8">
            <h2 className="text-lg font-normal text-black mb-4 font-[Alata]">Statistics</h2>
            <div className="space-y-4">
              <div className="flex justify-between items-center py-3 border-b border-gray-100">
                <span className="text-black font-[Alata]">Saved Profiles</span>
                <span className="text-black/70 font-[Alata]">
                  {userData.savedProfiles?.length || 0}
                </span>
              </div>
              <div className="flex justify-between items-center py-3 border-b border-gray-100">
                <span className="text-black font-[Alata]">Active Conversations</span>
                <span className="text-black/70 font-[Alata]">
          ...
          <div className="mb-8">
            <button
              ...
              className="w-full h-12 border border-red-300 rounded-[15px] text-red-600 font-[Alata] hover:bg-red-50 transition-colors"
            >
              Sign Out
            </button>
          </div>

    ...
    <AnimatedPageWrapper>
      <div className="w-full min-h-screen bg-white relative max-w-sm mx-auto overflow-x-hidden">
        ...
        <div className="px-10 pb-32">
          ...
          {userData.wallet && (
            <div className="mb-8">
              <h2 className="text-lg font-normal text-black mb-4 font-[Alata]">
                Wallet
              </h2>
              <div className="flex justify-between items-center py-3 border-b border-gray-100">
                <span className="text-black font-[Alata]">
                  Connected Wallet
                </span>
          ...
          <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-[20px] p-6 max-w-sm w-full mx-auto">
              ...
              <p className="text-black/70 font-[Alata] text-center mb-6">
                Are you sure you want to sign out? You'll need to reconnect your
                wallet to sign back in.
              </p>

...
export default function MessagesPage() {
  const { userData, sendMessage, getConversation, markMessagesAsRead } =
    useUser();
        ...
        {openChatId && currentChatProfile && (
          <div className="fixed inset-0 bg-black/50 z-50 flex flex-col">
            ...
            >
              ...
              {/* Chat Container */}
              <div
                className="flex-1 bg-white rounded-t-[44px] relative flex flex-col"
                ...
                <div className="pt-8 px-10 pb-6">
                  <div className="flex items-center justify-between">
                    ...
                    <button className="w-13 h-13 border border-[#E8E6EA] rounded-[15px] bg-white flex items-center justify-center">
                      ...
                      >
                        <path
                          d="M12 4.75C12.6904 4.75 13.25 5.30964 13.25 6C13.25 6.69036 12.6904 7.25 12 7.25C11.3096 7.25 10.75 6.69036 10.75 6C10.75 5.30964 11.3096 4.75 12 4.75Z"
                          fill="black"
                        />
                        <path
                        ...
                        />
                        <path
                          d="M12 16.25C12.6904 16.25 13.25 16.8096 13.25 17.5C13.25 18.1904 12.6904 18.75 12 18.75C11.3096 18.75 10.75 18.1904 10.75 17.5C10.75 16.8096 11.3096 16.25 12 16.25Z"
                          fill="black"
                        />
                      </svg>
                    </button>

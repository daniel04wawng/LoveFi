    ...
    <div className="min-h-screen bg-white px-5 py-5 relative">
      <div className="w-full max-w-[375px] mx-auto">
        ...
        <Link
          to="/"
          onClick={onBack}
          className="inline-flex items-center justify-center w-[52px] h-[52px] rounded-2xl border border-lovefi-border bg-white hover:bg-gray-50 transition-colors mb-6"
        >
          <svg 
            width="24" 
            height="24" 
        ...
        {/* Continue Button */}
        <div className="fixed bottom-8 left-1/2 transform -translate-x-1/2 w-full max-w-[295px] px-5">
          <button

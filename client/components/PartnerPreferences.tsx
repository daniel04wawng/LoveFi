...
export default function PartnerPreferences({ onContinue, onBack }: PartnerPreferencesProps) {
  ...
  const renderToggleButton = (category: PreferenceCategory, categoryIndex: number) => {
        ...
        <div className="relative w-full h-[58px] bg-white border border-lovefi-border rounded-2xl overflow-hidden">
          ...
          <div 
            ...
            style={{
              ...
              borderRadius: category.selected === 0 ? '15px 0 0 15px' : 
                           category.selected === 2 ? '0 15px 15px 0' : '0'
            }}
          />
        ...
        <div className="relative w-full h-[59px] bg-white border border-lovefi-border rounded-2xl overflow-hidden">
          ...
          <div 
            ...
            style={{
              ...
              borderRadius: category.selected === 0 ? '15px 0 0 15px' : '0 15px 15px 0'
            }}
          />

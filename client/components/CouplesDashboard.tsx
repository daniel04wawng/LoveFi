          ...
          <div className="flex items-center justify-between px-5 pt-12 pb-6">
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-1">
                ...
                <span className="text-gray-900 font-alata font-bold">
                  {currentStreak} days
                </span>
              </div>
            </div>
            <div className="text-right">
              <div className="text-xl font-alata font-bold text-gray-900">
          ...
          <div className="px-5 space-y-4 pb-24">
            ...
            <div className="bg-white rounded-2xl p-4 border border-gray-100">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-gray-900 font-alata font-medium mb-1">
                    Days Together
                  </h3>
                  <div className="text-2xl font-bold text-lovefi-purple">
                    {relationshipDays}
                  </div>
                  <div className="text-xs text-gray-500">
